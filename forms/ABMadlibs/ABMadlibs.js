...
*/
lblmadlib.textContent = `A ${n1} in Nebraska was arrested this morning after ${v1}ing in front of a ${a1} ${n2}. The perpetrator had a history of ${v2}ing, but no one - not even her ${n3} - ever imagined she would ${v3} with a ${n4}.
Even her ${n5} was surprised. I always thought she was ${a2}, but I never thought she'd do something like this. Either way, we imagine that after witnessing her ${v4}ing with a ${a3}`
